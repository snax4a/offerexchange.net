          ...
          <div className='grow space-y-3'>
            {accordionData.map((item: AccordionItem) => (
              <Disclosure key={item.title}>
                {({ open }) => (
                  <>
                    <Disclosure.Button className='focus-visible:ring-seconrady flex w-full justify-between rounded-lg bg-secondary/10 p-4 text-left text-sm font-medium text-secondary hover:bg-secondary/20 focus:outline-none focus-visible:ring focus-visible:ring-opacity-75'>
