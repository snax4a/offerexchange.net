        ...
        <div className='hidden lg:absolute lg:inset-y-0 lg:block lg:h-full lg:w-full'>
          <div className='relative mx-auto h-full max-w-prose text-lg' aria-hidden='true'>
            <SquaresPattern
              width={404}
              height={450}
              className='absolute top-12 left-full translate-x-32 transform text-secondary/20'
            />
            <SquaresPattern
              width={404}
              height={450}
              className='absolute top-1/2 right-full -translate-y-1/2 -translate-x-32 transform text-secondary/20'
            />
            <SquaresPattern
              width={404}
              height={450}
              className='absolute bottom-12 left-full translate-x-32 transform text-secondary/20'
            />
          </div>
        </div>
