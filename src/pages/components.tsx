            ...
            <ol className='mt-8 space-y-6'>
              ...
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <UnstyledLink href='https://offerexchange.net'>
                    Outside Links
                  </UnstyledLink>
                </div>
              </li>
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <PrimaryLink href='https://offerexchange.net'>
                    Outside Links
                  </PrimaryLink>
                </div>
              </li>
              <li className='space-y-2'>
                ...
                <div className='space-x-2'>
                  ...
                  <UnderlineLink href='https://offerexchange.net'>
                    Outside Links
                  </UnderlineLink>
                </div>
              </li>
              ...
              <li className='space-y-2'>
                ...
                <div className='flex flex-wrap gap-2'>
                  <ButtonLink variant='primary' href='https://offerexchange.net'>
                    Primary Variant
                  </ButtonLink>
                  <ButtonLink
                    variant='outline'
                    isDarkBg={mode === 'dark'}
                    href='https://offerexchange.net'
                  >
                    Outline Variant
                  </ButtonLink>
                  <ButtonLink
                  ...
                  <ButtonLink variant='dark' href='https://offerexchange.net'>
                    Dark Variant
                  </ButtonLink>
                  <ButtonLink variant='light' href='https://offerexchange.net'>
                    Light Variant
                  </ButtonLink>
                </div>
              </li>
